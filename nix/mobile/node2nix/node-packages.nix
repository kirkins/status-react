...
let
  sources = {
    ...
    "react-native-status-keycard-git+https://github.com/status-im/react-native-status-keycard.git#v2.5.4" = {
      ...
      src = fetchgit {
        ...
        rev = "e60ff4ff4477af8d0bffb7f42153b552bde2f746";
        sha256 = "c16dd3968cd4af1bb7ee69f721e98bfc73703705b69afa387a89133caa49371a";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."react-native-status-keycard-git+https://github.com/status-im/react-native-status-keycard.git#v2.5.4"
