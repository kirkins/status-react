...
(def v15
  (-> v14
      (update :properties dissoc :message-overhead)
      (update :properties dissoc :removed-from-at)
      (update :properties dissoc :added-to-at)
      (update :properties dissoc :removed-at)))
